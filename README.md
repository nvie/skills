...
| [visually-explain](skills/visually-explain/) | 0 - Experimental                                    | Produce a single self-contained interactive HTML document that visually explains an approach, architecture, or algorithm -- toggles, steppers, diffs, and color-coded state for visual learners who find static markdown insufficient. |
