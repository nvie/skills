...
| [quick-explainer](skills/quick-explainer/)                       | 0 - Experimental                                    | Prime your brain for a context switch: point at a PR, tech design, plan, Mikado graph, or the current branch and get back one concrete worked example -- what goes wrong today, what the same scenario looks like after -- in under one terminal window. No abstraction, no summary, no theory.                                                                              |
...
| [slack](skills/slack/)                                           | 0 - Experimental                                    | Turn whatever you give it into a ready-to-paste Slack message in nvie's casual voice -- Slack-flavored markup, no line wrapping, no corporate padding, and nothing in the output but the message itself.                                                                                                                                                                     |
